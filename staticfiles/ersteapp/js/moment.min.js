...
!(function (a, b) {
  ...
  function fa(a, b) {
    return a
      ? c(this._months)
        ...
        : this._months[
            (this._months.isFormat || ke).test(b) ? 'format' : 'standalone'
          ][a.month()]
      : this._months;
  }
  function ga(a, b) {
    return a
      ? c(this._monthsShort)
        ...
        : this._monthsShort[ke.test(b) ? 'format' : 'standalone'][a.month()]
      : this._monthsShort;
  }
  function ha(a, b, c) {
    var d,
    ...
    return c
      ? 'MMM' === b
        ? ((e = je.call(this._shortMonthsParse, g)), e !== -1 ? e : null)
  ...
  function Ia(a, b, c) {
    ...
    return c
      ? 'dddd' === b
        ...
        : 'ddd' === b
          ? ((e = je.call(this._shortWeekdaysParse, g)), e !== -1 ? e : null)
          : ((e = je.call(this._minWeekdaysParse, g)), e !== -1 ? e : null)
      : 'dddd' === b
  ...
  function Oa(a) {
    return this._weekdaysParseExact
      ...
      : (i(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = ve),
  ...
  function kb(b) {
    ...
    for (e = Y(b._f, b._locale).match(Fd) || [], c = 0; c < e.length; c++)
      (f = e[c]),
        ...
        Id[f]
          ? (d ? (m(b).empty = !1) : m(b).unusedTokens.push(f), da(f, d, b))
  ...
  function Ec(a, b, c, d, e) {
    ...
    return null == a
      ? wa(this, d, e).year
      : ((f = xa(a, d, e)), b > f && (b = f), Fc.call(this, a, b, c, d, e));
  }
